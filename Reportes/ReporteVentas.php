<?php 
  ...
  $usuario = 'SELECT detalleventa.id_venta, detalleventa.descripcion, detalleventa.cantidad, detalleventa.precio, 
          detalleventa.importe, venta.total,  
          venta.status
          FROM detalleventa
          right join venta
          on venta.id_venta = detalleventa.id_venta';
