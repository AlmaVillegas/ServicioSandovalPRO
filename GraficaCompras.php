...
<html>  
    ...
    <body>
        <button type="button" class="<?php echo $vboton; ?>" onClick="window.location='caja2.php'">Regresar A Compras</button>
   <!-- Grafica de compras por mes y reporteeeee -->
   <!--///////////////////////////////////////////////////////////////////////////////////--> 
    ...
    <script>
            $(document).ready(mostrarResultados(2018));  
                function mostrarResultados(año){
                    $.ajax({
                        type:'POST',
                        url:'Graficas/controladorCompra/procesar.php',
                        data:'año='+año,
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>Compras</b></h4>
            </div>
